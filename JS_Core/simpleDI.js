...
// Можно назвать этот птимер внедрением зависимости в теле функции.
...
//  лавинообразную последовательность изменений в приложении. (нарушение паттерна GRASP Слабая связанность (зацепление) или Low Coupling
//  Если объекты в приложении сильно связанны, то любой их изменение приводит к изменениям во всех связанных объектах. А это неудобно и порождает множество проблем.)
