...
// Этот пример рабочий, в функции checkUser успешно создается переменная user.
// Однако такой подход иногда вызывает проблемы.
// Давайте мы изменим функцию user (например добавим параметр)
...
//  Получается, что одна функция зависит от имплементации другй, что нарушает один из принципов SOLID -
...
//  При изменениях в функции user мы должны найти все места её использования в других функциях и внести изменения, что очень не удобно.
