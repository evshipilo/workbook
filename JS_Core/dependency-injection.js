...
// Давайте рассмотрим этот пример, классу Car требуется инстанс класса Tires. Мы можем сказать что Car зависит от класса Tires.
// Как мы видим - этот пример рабочий, в классе Car успешно инициализируется поле tires инстансом класса Tires.
